...
u1=0.11;u2=0.09;u3=0.11;u4=0.09;u5=0.11;u6=0.09;u7=0.11;u8=0.09;u9=0.11;u10=0.09;%service node service distribution
...
while b<=10 %γ
    ...
    while a<=10 %β
        ...
        x = [x;a] ;
        y1= [y1;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*total.Q.L)/T)+a*maxaoi/T)];%POA
        y2= [y2;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*without_total.Q.L)/T)+a*without_maxaoi/T)];%POA
        y3= [y3;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*greedy_total.Q.L)/T)+a*greedy_maxaoi/T)];%POA
        y4= [y4;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*random_total.Q.L)/T)+a*random_maxaoi/T)];%POA
        y5= [y5;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*lbfs_total.Q.L)/T)+a*lbfs_maxaoi/T)];%POA
        y6= [y6;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*fbfs_total.Q.L)/T)+a*fbfs_maxaoi/T)];%POA
