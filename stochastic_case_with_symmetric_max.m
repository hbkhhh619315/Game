...
while b<=10 %γ
    ...
    while a<=10 %β
        ...
        y3= [y3;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*random_total.Q.L)/T)+a*random_maxaoi/T)];%POA
        y4= [y4;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*lbfs_total.Q.L)/T)+a*lbfs_maxaoi/T)];%POA
        y5= [y5;1-((((b*(1/15)/sevices)*opt.total.Q.L)/T)+a*opt.maxaoi/T)/((((b*(1/15)/sevices)*fbfs_total.Q.L)/T)+a*fbfs_maxaoi/T)];%POA
